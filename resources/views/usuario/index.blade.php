    ...
    <div class="py-8 bg-gradient-to-b from-blue-900 to-indigo-900 text-white min-h-screen">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="text-center mb-12">
                <h1 class="text-4xl font-extrabold mb-2">PES COMMUNITY</h1>
                <p class="text-lg text-orange-400">El legado de Konami en el fútbol digital</p>
                <a href="#archivo" class="mt-6 inline-block bg-orange-400 hover:bg-orange-500 text-white font-semibold py-3 px-6 rounded-full transition">
                    Empezar a Explorar
                </a>
            </div>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
                @foreach ($pesList as $pes)
                    <div class="bg-gray-800 rounded-xl p-6 relative shadow-lg">
                        <span class="absolute top-4 right-4 bg-orange-400 text-black font-bold text-sm px-3 py-1 rounded-full">
                        ...
                        <div class="flex justify-between items-center gap-2">
                            <a href="{{ $pes->Link_Descarga }}" target="_blank"
                               class="bg-blue-500 hover:bg-blue-600 text-white text-sm px-3 py-1 rounded shadow">
                                Descargar
                            </a>
                            <a href="{{ route('soundtracks.show', $pes->idPES) }}"
                               class="bg-gray-600 hover:bg-gray-700 text-white text-sm px-3 py-1 rounded shadow">
                                Soundtrack
                            </a>
                            <a href="{{ route('pes.show', $pes->idPES) }}"
                               class="bg-orange-500 hover:bg-orange-600 text-white text-sm px-3 py-1 rounded shadow">
                                Detalles
                            </a>
                        </div>
                    </div>
